...
<required_reading>
@D:/projets/android/locut/.zcode/gsd-core/references/verification-overrides.md
@D:/projets/android/locut/.zcode/gsd-core/references/gates.md
@D:/projets/android/locut/.zcode/gsd-core/references/verifier-phase-gates.md
</required_reading>
...
@D:/projets/android/locut/.zcode/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@D:/projets/android/locut/.zcode/gsd-core/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@D:/projets/android/locut/.zcode/gsd-core/references/verify-mvp-mode.md`.
