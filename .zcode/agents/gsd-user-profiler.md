...
<reference>
@D:/projets/android/locut/.zcode/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `D:/projets/android/locut/.zcode/gsd-core/references/user-profiling.md` to load:
