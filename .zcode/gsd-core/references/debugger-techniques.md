...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/projets/android/locut/.zcode
                  → checks D:/projets/android/locut/.zcode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/projets/android/locut/.zcode/gsd-core
                  → writes to D:/projets/android/locut/.zcode/gsd-core/hooks/
