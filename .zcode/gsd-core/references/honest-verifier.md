...
`@D:/projets/android/locut/.zcode/gsd-core/references/edge-probe.md` (which *classifies* non-inferable checks) and
`@D:/projets/android/locut/.zcode/gsd-core/references/prohibition-probe.md` (whose judgment-tier disposition this mirrors).
