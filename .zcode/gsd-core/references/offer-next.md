...
Read and follow `D:/projets/android/locut/.zcode/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
