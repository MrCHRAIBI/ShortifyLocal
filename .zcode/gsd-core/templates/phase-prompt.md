...
<!-- For checkpoint task examples and patterns, see @D:/projets/android/locut/.zcode/gsd-core/references/checkpoints.md -->
...
See `D:/projets/android/locut/.zcode/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/projets/android/locut/.zcode/gsd-core/templates/user-setup.md` for full schema and examples
