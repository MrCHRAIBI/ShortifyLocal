...
```markdown
Read D:/projets/android/locut/.zcode/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/projets/android/locut/.zcode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/projets/android/locut/.zcode/agents/gsd-ui-checker.md for instructions.
...
@D:/projets/android/locut/.zcode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / D:/projets/android/locut/.zcode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "D:/projets/android/locut/.zcode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "D:/projets/android/locut/.zcode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
