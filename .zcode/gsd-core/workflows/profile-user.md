...
Key references:
- @D:/projets/android/locut/.zcode/gsd-core/references/ui-brand.md (display patterns)
- @D:/projets/android/locut/.zcode/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/projets/android/locut/.zcode/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/projets/android/locut/.zcode/gsd-core/USER-PROFILE.md"
...
```bash
cp "D:/projets/android/locut/.zcode/gsd-core/USER-PROFILE.md" "D:/projets/android/locut/.zcode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/projets/android/locut/.zcode/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/projets/android/locut/.zcode/gsd-core/references/user-profiling.md`
...
Reference: @D:/projets/android/locut/.zcode/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to D:/projets/android/locut/.zcode/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/projets/android/locut/.zcode/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/projets/android/locut/.zcode/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/projets/android/locut/.zcode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/projets/android/locut/.zcode/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/projets/android/locut/.zcode/USER-PROFILE.backup.md"
```
...
Your profile:    D:/projets/android/locut/.zcode/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/projets/android/locut/.zcode/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.zcode/CLAUDE.md>
  ✓ Global CLAUDE.md        D:/projets/android/locut/.zcode/CLAUDE.md
```

(Show the `claude_md_path` actually returned by the command — it defaults to `./.zcode/CLAUDE.md` but may be overridden by config or `--output`.)
