...
- Generates `./.zcode/skills/spike-findings-[project]/` with references and sources
...
- Generates `./.zcode/skills/sketch-findings-[project]/` with design decisions, CSS patterns, HTML structures
...
- Saves timestamped note to `.planning/notes/` (or `D:/projets/android/locut/.zcode/notes/` globally)
