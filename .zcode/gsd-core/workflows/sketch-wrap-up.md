...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.zcode/skills/sketch-findings-[project]/`
...
3. Check if `./.zcode/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.zcode/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.zcode/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.zcode/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.zcode/skills/` with SKILL.md, references/, sources/
