...
<required_reading>
@D:/projets/android/locut/.zcode/gsd-core/references/user-story-template.md
@D:/projets/android/locut/.zcode/gsd-core/references/spidr-splitting.md
@D:/projets/android/locut/.zcode/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/projets/android/locut/.zcode/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/projets/android/locut/.zcode/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/projets/android/locut/.zcode/gsd-core/references/spidr-splitting.md`. Briefly:
