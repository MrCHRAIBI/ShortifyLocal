...
`./.zcode/skills/spike-findings-[project]/` (project-local) and summary to
...
3. Check if `./.zcode/skills/spike-findings-*/SKILL.md` exists for this project
...
2. The skill will be created at `./.zcode/skills/spike-findings-[project-dir-name]/`
...
**Feature areas:** [list]
**Skill output:** `./.zcode/skills/spike-findings-[project]/`
...
**Processed:** {N} spikes
**Feature areas:** {list}
**Skill:** `./.zcode/skills/spike-findings-[project]/`
...
- [ ] Spike-findings skill exists at `./.zcode/skills/` with SKILL.md (including requirements), references/, sources/
