...
```
Agent(
  prompt="Read D:/projets/android/locut/.zcode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/projets/android/locut/.zcode/gsd-core/templates/SECURITY.md`
