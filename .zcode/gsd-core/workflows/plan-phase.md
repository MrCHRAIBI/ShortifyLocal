...
@D:/projets/android/locut/.zcode/gsd-core/references/ui-brand.md
@D:/projets/android/locut/.zcode/gsd-core/references/revision-loop.md
@D:/projets/android/locut/.zcode/gsd-core/references/gate-prompts.md
...
- Planner is instructed to produce `SKELETON.md` in the phase directory alongside `PLAN.md`. The template lives at `D:/projets/android/locut/.zcode/gsd-core/references/skeleton-template.md` — the planner reads it when producing SKELETON.md (lazy; not loaded on non-skeleton runs).
...
**If found:**
1. Read template: `D:/projets/android/locut/.zcode/gsd-core/templates/VALIDATION.md`
...
SPIKE_FINDINGS_PATH=$(ls ./.zcode/skills/spike-findings-*/SKILL.md 2>/dev/null | head -1 || true)
SKETCH_FINDINGS_PATH=$(ls ./.zcode/skills/sketch-findings-*/SKILL.md 2>/dev/null | head -1 || true)
...
**Read and run** the gate + edge probe in `D:/projets/android/locut/.zcode/gsd-core/references/specless-probe-fallback.md`
...
**Project instructions:** Read ./CLAUDE.md or ./.zcode/CLAUDE.md if either exists — follow project-specific guidelines
...
**MVP_MODE:** ${MVP_MODE} (when true, follow vertical-slice rules from `D:/projets/android/locut/.zcode/gsd-core/references/planner-mvp-mode.md`; when false, ignore MVP guidance entirely.)
**WALKING_SKELETON:** ${WALKING_SKELETON} (when true, the first deliverable must be a Walking Skeleton — Read the template at `D:/projets/android/locut/.zcode/gsd-core/references/skeleton-template.md` and produce SKELETON.md alongside PLAN.md.)
**Granularity:** {granularity}

${MVP_MODE === 'true' ? `
<mvp_mode_active>
**MVP Mode is ENABLED.** Read `D:/projets/android/locut/.zcode/gsd-core/references/planner-mvp-mode.md` now and follow its vertical-slice planning rules. Each plan must deliver a complete vertical slice — thin end-to-end functionality rather than horizontal layers.
</mvp_mode_active>
` : ''}
...
else-branch below, per §A/§B/§C of `D:/projets/android/locut/.zcode/gsd-core/references/specless-probe-fallback.md`
...
**Project instructions:** Read ./CLAUDE.md or ./.zcode/CLAUDE.md if either exists — verify plans honor project guidelines
