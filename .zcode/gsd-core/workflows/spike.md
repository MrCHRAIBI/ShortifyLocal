...
**b. Findings skills** — glob `./.zcode/skills/spike-findings-*/SKILL.md` and read any that exist, plus their `references/*.md`. These contain curated knowledge from prior wrap-ups.
...
**b. Findings skills:** Glob for `./.zcode/skills/spike-findings-*/SKILL.md` and read any that exist, plus their `references/*.md` files.
