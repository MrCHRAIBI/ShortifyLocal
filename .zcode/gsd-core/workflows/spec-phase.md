...
ones). Reference: @D:/projets/android/locut/.zcode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / D:/projets/android/locut/.zcode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "D:/projets/android/locut/.zcode/gsd-core/bin/lib/edge-probe.cjs" \
  "D:/projets/android/locut/.zcode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @D:/projets/android/locut/.zcode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @D:/projets/android/locut/.zcode/gsd-core/templates/spec.md.
