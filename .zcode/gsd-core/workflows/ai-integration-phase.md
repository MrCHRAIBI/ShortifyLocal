...
<required_reading>
@D:/projets/android/locut/.zcode/gsd-core/references/ai-frameworks.md
@D:/projets/android/locut/.zcode/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/projets/android/locut/.zcode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/projets/android/locut/.zcode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/projets/android/locut/.zcode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/projets/android/locut/.zcode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/projets/android/locut/.zcode/agents/gsd-eval-planner.md for instructions.
